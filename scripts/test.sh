...
pretrained_exp_pose=./checkpoints/KITTI_formatted,epoch_size3000,m0.2/11-07-22:40/exp_pose_model_best.pth.tar
pretrained_disp=./checkpoints/KITTI_formatted,epoch_size3000,m0.2/11-07-22:40/dispnet_model_best.pth.tar
