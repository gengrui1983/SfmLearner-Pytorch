...
parser.add_argument("pretrained_dispnet", type=str, help="pretrained DispNet path")
...
def main():
    ...
    from kitti_eval.pose_evaluation_utils import test_framework_KITTI as pose_test_framework
    ...
    framework = pose_test_framework(dataset_dir, args.sequences, seq_length)
